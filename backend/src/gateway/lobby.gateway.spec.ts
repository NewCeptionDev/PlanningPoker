...
describe('LobbyGateway', () => {
  ...
  describe('handleJoinLobby', () => {
    it('should join lobby when joinLobby', () => {
      ...
      const joinLobbySpy = jest.spyOn(service, 'addUserToLobby').mockImplementation()

      gateway.handleJoinLobby(lobbyId, userId, name, role, socket)

      expect(joinLobbySpy).toHaveBeenCalledWith(lobbyId, userId, name, role, socket)
    })
  })
  ...
  describe('handleSelectCard', () => {
    it('should select card when selectCard', () => {
      ...
      const selectCardSpy = jest.spyOn(service, 'selectCardForUser').mockImplementation()
  ...
  describe('handleLeaveLobby', () => {
    it('should leave lobby when leaveLobby', () => {
      ...
      const leaveLobbySpy = jest.spyOn(service, 'removeUserFromLobby').mockImplementation()
  ...
  describe('handleShowCards', () => {
    it('should show cards when showCards', () => {
      ...
      const showCardsSpy = jest.spyOn(service, 'showCards').mockImplementation()
  ...
  describe('handleReset', () => {
    it('should reset lobby when reset', () => {
      ...
      const resetLobbySpy = jest.spyOn(service, 'resetLobby').mockImplementation()
