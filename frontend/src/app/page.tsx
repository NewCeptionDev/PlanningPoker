...
export default function Home() {
  ...
  return (
    <main className='h-screen light-bg dark:dark-bg'>
      ...
      <div
        id='content'
        className='flex flex-col justify-center items-center h-[66vh]'
      >
        <div
          id='lobby-join'
        ...
        <div
          id='spacer'
          className='w-1/3 h-0.5 self-center m-8 secondary'
        ></div>
        <div
          id='lobby-create'
        ...
        >
          ...
          >
            ...
            <select
              ...
              data-testid='cardGroupSelect'
            >
              {Array.from(cardGroupSelection.entries()).map(([key, value]) => (
                <option
                  key={key}
                  value={key}
                  className='w-[90%] max-w-[90%] overflow-ellipsis'
                >
                  {key}
            ...
            {selectedCardGroup === 'Custom' ? (
              <>
                ...
                <input
                  ...
                  className='input'
                  data-testid='lobby-create-custom-cards'
                />
              </>
            ) : (
              <></>
